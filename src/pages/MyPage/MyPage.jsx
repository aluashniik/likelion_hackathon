...
//         } else {
//           setApiError(res.message || '프로필 조회에 실패했습니다.');
//         }
//       } catch (error) {
//         console.error("프로필 정보를 가져오는 데 실패했습니다.", error);
//         setApiError('네트워크 또는 서버 오류가 발생했습니다.');
//       } finally {
//         setLoading(false);
//       }
//     };
...
//       { key: 'contact-admin', label: '운영진 문의', to: '/mypage/contact' },
//     ],
//     guest: [{ key: 'contact-admin', label: '운영진 문의', to: '/mypage/contact' }],
//   };

//   if (loading) return <div>로딩 중...</div>;
//   if (apiError) return <div>{apiError}</div>;
//   if (!userData) return <div>프로필 정보를 불러올 수 없습니다.</div>;

//   const role = userData.user_role || localStorage.getItem('userRole') || 'guest';
